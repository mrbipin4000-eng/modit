...
class Curve_UI(QtWidgets.QDialog):
    ...
    def buildUI(self):
        ...
        try:
            getValueS = mc.getAttr("ModIt_Duplicate_Curve" + str(Num) + "_Random.scaleX")
        except:
            getValueS = 0
    ...
    def SpinScaleRandom_Action(self):
        ...
        mc.setAttr("ModIt_Duplicate_Curve" + str(Num) + "_Random.scaleX", SpinBoxValue)
        mc.setAttr("ModIt_Duplicate_Curve" + str(Num) + "_Random.scaleY", SpinBoxValue)
        mc.setAttr("ModIt_Duplicate_Curve" + str(Num) + "_Random.scaleZ", SpinBoxValue)
