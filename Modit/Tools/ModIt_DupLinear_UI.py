...
class Linear_UI(QtWidgets.QDialog):
    ...
    def buildUI(self):
        ...
        # ___________________________________________## RANDOM SCALE
        # ___________________________________________##
        ...
        try:
            getValueS = mc.getAttr("ModIt_Duplicate" + str(Num) + "_Random.scaleX")
        except:
            getValueS = 0
    ...
    def SpinScaleRandom_Action(self):
        ...
        mc.setAttr("ModIt_Duplicate" + str(Num) + "_Random.scaleX", SpinBoxValue)
        mc.setAttr("ModIt_Duplicate" + str(Num) + "_Random.scaleY", SpinBoxValue)
        mc.setAttr("ModIt_Duplicate" + str(Num) + "_Random.scaleZ", SpinBoxValue)
