...
class SHADING_LAYOUT(QtWidgets.QWidget):
    ...
    def showPopupPlanar(self, position):
        self.popupMenuPlanar.exec(self.UvPlanar_btn.mapToGlobal(position))
        self.UvPlanar_btn.update()

    def showPopupHDR(self, position):
        self.popupMenuHDR.exec(self.Hdri_btn.mapToGlobal(position))
        self.Hdri_btn.update()

    def showPopupLight(self, position):
        self.popupMenuLight.exec(self.LightsOff_btn.mapToGlobal(position))
