...
class UTILITIES_LAYOUT(QtWidgets.QWidget):
    ...
    def showPopup_CenterPivot(self, position):
        self.popupMenu_CenterPivot.exec(self.CenterPivot_btn.mapToGlobal(position))
        self.CenterPivot_btn.update()

    def showPopup_DelHisto(self, position):
        self.popupMenu_DelHisto.exec(self.DelHistory_btn.mapToGlobal(position))
        self.DelHistory_btn.update()

    def showPopup_BtoA(self, position):
        self.popupMenu_BtoA.exec(self.BtoA_btn.mapToGlobal(position))
